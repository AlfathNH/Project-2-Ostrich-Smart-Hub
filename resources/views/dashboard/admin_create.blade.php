            ...
            <form action="{{ route('admin.animal.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label class="block text-xs font-semibold text-white/60 mb-2 uppercase tracking-wider">
                        <i class="fa-solid fa-tag mr-1.5 text-gold/50"></i>Nama Hewan <span class="text-red-400 font-bold">*</span>
                    </label>
                ...
                <div>
                    <label class="block text-xs font-semibold text-white/60 mb-2 uppercase tracking-wider">
                        <i class="fa-solid fa-layer-group mr-1.5 text-gold/50"></i>Jumlah (Ekor) <span class="text-red-400 font-bold">*</span>
                    </label>
                ...
                <div>
                    <label class="block text-xs font-semibold text-white/60 mb-2 uppercase tracking-wider">
                        <i class="fa-solid fa-bowl-food mr-1.5 text-gold/50"></i>Rincian Pakan <span class="text-red-400 font-bold">*</span>
                    </label>
