...
// --- DASHBOARD ZOOKEEPER ---
Route::get('/zookeeper',       fn() => redirect()->route('zookeeper.pakan'));
Route::get('/zookeeper/pakan', [AdminController::class, 'zookeeperPakan'])->name('zookeeper.pakan');
Route::get('/zookeeper/medis', [AdminController::class, 'zookeeperMedis'])->name('zookeeper.medis');
Route::post('/zookeeper/tandai/{animal_id}', [AdminController::class, 'zookeeperTandai'])->name('zookeeper.tandai');
